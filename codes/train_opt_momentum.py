...
runner.train([train_imgs, train_labs], [valid_imgs, valid_labs], num_epochs=5, log_iters=100, save_dir=os.path.join(BASE_DIR, 'best_models', 'opt_momentum_run'))
...
figure_path = os.path.join(BASE_DIR, 'figs', 'opt_momentum_curve.png')
