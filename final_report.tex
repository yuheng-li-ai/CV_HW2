...
The code repository is available online.\footnote{\url{https://github.com/yuheng-li-ai/CV_HW2}} The checkpoint/model weights are available on ModelScope.\footnote{\url{https://modelscope.cn/models/yuhengli/deeplearning-project1}}
